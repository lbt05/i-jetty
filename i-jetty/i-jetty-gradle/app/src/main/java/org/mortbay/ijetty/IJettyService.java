            ...
            public void handleMessage(Message msg) {
                switch (msg.getData().getInt("state"))
                {
                    case __STARTED:
                    {
                        ...
                        builder.setSmallIcon(R.drawable.ijetty_stat).setContentText(text).setWhen(System.currentTimeMillis()).setContentTitle(getText(R.string.app_name)).setContentIntent(contentIntent);;
...
//                                text, contentIntent);
                        ...
                        mNM.notify(R.string.jetty_started, builder.build());
                        
                        Intent startIntent = new Intent(IJetty.__STARTED_ACTION);
                    ...
                    case __STOPPED:
                    {
                        ...
                        Intent stopIntent = new Intent(IJetty.__STOPED_ACTION);
